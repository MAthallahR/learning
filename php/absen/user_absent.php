...
// Check if you are absent or not$namaaa = [];
if($classabsent){
...
<body>
    <form action="user_absent.php" method="POST">
        ...
        ?>
    <a href="user_absent.php">Reset</a>
    <a href="user_absentrecords.php">View Absences</a>
    </form>
</body>
</html>